...
@Component({
  selector: 'ftc-find-book-page',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <ftc-book-search [query]="searchQuery$ | async" [searching]="loading$ | async" [error]="error$ | async" (search)="search($event)"></ftc-book-search>
    <ftc-book-preview-list [books]="books$ | async"></ftc-book-preview-list>
  `,
})
